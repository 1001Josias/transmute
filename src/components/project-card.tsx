    ...
    >
      ...
      <div className="grid grid-cols-4 gap-2">
        <div className="text-center p-2 rounded-lg bg-slate-900/50">
          <div className="text-lg font-bold text-green-400">{project.taskStats.done}</div>
          <div className="text-xs text-slate-500">Done</div>
        </div>
        <div className="text-center p-2 rounded-lg bg-slate-900/50">
          <div className="text-lg font-bold text-yellow-400">{project.taskStats.inProgress}</div>
          <div className="text-xs text-slate-500">In Progress</div>
        </div>
        <div className="text-center p-2 rounded-lg bg-slate-900/50">
          <div className="text-lg font-bold text-slate-400">{project.taskStats.todo}</div>
          <div className="text-xs text-slate-500">To Do</div>
        </div>
        <div className="text-center p-2 rounded-lg bg-slate-900/50">
          <div className="text-lg font-bold text-red-400">{project.taskStats.blocked}</div>
